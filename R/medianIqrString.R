#' medianIqrString returns a formatted string detailing median and IQR
#'
...
#' @param probs numeric vector of probabilities with values in [0,1], default 0.25 and 0.5, only first two probs will be reported as range
#' @param digits numeric number of digits for rounding, default=2
#'
#' @return result_string
#' @export
#'
medianIqrString <- function(x, na.rm=T, probs=c(0.25, 0.5), digits=2) {
